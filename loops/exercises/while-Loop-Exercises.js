...
/*Exercise #4: Construct while loops to do the following:
  a. Query the userfor the starting fuel level. Validate that the user enters a positive, integer value greater than 5000 but less than 30000. */
...
//b. Use a second loop to query the user for the number of astronauts (up to a maximum of 7). Validate the entry.
  while (numAstronauts <= 0 || numAstronauts > 7 || isNaN(numAstronauts)) {
    numAstronauts = input.question("Plese enter the number of astronauts: ")
  }
